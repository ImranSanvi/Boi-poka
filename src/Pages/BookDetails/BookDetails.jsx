...
const BookDetails = () => {
  ...
  const handleMarkAsRead = (id) => {
    ...
    const handleAddWhishList = (id) => {
      toast("Wow Add to Wish List!");
  };
    ...
    <div className="flex flex-col md:flex-row gap-10 m-[30px] md:m-[100px]">
      ...
      <div className="md:w-1/2 space-y-4">
        ...
        <p className="font-normal text-[16px] text-[#131313]/70">
          {" "}
          <span className="font-bold text-[16px] text-[#131313]">
            Review:
          </span>{" "}
          {review}
        </p>
        ...
        <div className="flex gap-10">
          ...
          {tags.map((tag, index) => (
            <button
              key={index}
              className="font-medium text-[16px] text-[#23BE0A] "
            >
              {tag}
            </button>
          ))}
        ...
        <div className="flex flex-col md:flex-row gap-10">
          <button
            ...
            className="bg-gray-500 px-5 py-3 rounded-2xl"
          >
            Mark as Read
          </button>
          <ToastContainer />
          <button onClick={ () => handleAddWhishList(id)} className="bg-green-500 px-5 py-3 rounded-2xl">
            Add to Wishlist
          </button>
        </div>
      </div>
